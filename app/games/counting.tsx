...
type Level = { emoji: string; count: number; options: number[] };
...
export default function CountingGamePage() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Sayma Oyunu</Text>
      <Text style={styles.subtitle}>Nesneleri say ve doğru cevabı seç!</Text>
      ...
      <View style={styles.gameBox}>
        <View style={styles.itemsDisplay}>
          {Array.from({ length: currentQuestion.count }).map((_, index) => (
            <Text key={index} style={styles.itemEmoji}>
              {currentQuestion.emoji}
            </Text>
          ))}
        </View>
        <Text style={styles.question}>Kaç tane var?</Text>
        ...
        {showResult && (
          <View style={[styles.resultBox, isCorrect ? styles.resultSuccess : styles.resultError]}>
            ...
            <Text style={styles.resultText}>
              {isCorrect ? 'Harika! Doğru saydın!' : `Doğru cevap: ${currentQuestion.count}`}
            </Text>
